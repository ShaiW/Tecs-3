...
import simulators.GUI.components.*;
import simulators.hardwareSimulator.gates.*;
...
public class ROM32K extends BuiltInGateWithGUI
 implements ComputerPartEventListener, ProgramEventListener {
    ...
    protected void loadProgram(String fileName) throws AssemblerException {
        short[] program = new short[AsmProgram.MAXIMUM_PROGRAM_SIZE];
        int pc = 0;
        for(AsmLine al : AssemblyTranslator.loadProgram(fileName)) {
        	program[pc++] = al.value();
        }
