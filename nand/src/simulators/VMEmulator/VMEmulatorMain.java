  ...
  public static void main(String[] args) {
        if (args.length > 1)
			...
			VMEmulatorApplication application =
                new VMEmulatorApplication(controllerGUI, simulatorGUI, SCRIPTS_PATH+"defaultVM.txt",
                                          HELPFILES_PATH+"vmUsage.html", HELPFILES_PATH+"vmAbout.html");
        }
        else
